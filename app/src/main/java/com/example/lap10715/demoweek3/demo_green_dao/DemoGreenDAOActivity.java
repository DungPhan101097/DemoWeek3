...
public class DemoGreenDAOActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myAdapter = new MyAdapter(this, R.layout.custom_item_note);
        lvNotes.setAdapter(myAdapter);

        lvNotes.setOnItemClickListener((parent, view, position, id) -> {
            PopupMenu popup = new PopupMenu(DemoGreenDAOActivity.this, view);
            ...
            popup.setOnMenuItemClickListener(item -> {
                ...
                switch (id1){
                    case R.id.item_modify:
                        ...
                        Intent intent = new Intent(DemoGreenDAOActivity.this,
                    ...
                    case R.id.item_delete:
                        DeleteDialog deleteDialog = new DeleteDialog(DemoGreenDAOActivity.this,
                                position);
                        deleteDialog.show();
                        return true;
                }
