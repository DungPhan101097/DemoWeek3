...
public class NewNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnNew.setOnClickListener(v -> {
            ...
            if(isModify){
                setResult(DemoGreenDAOActivity.RESULT_MODIFY_NOTE,returnIntent);
            }
            else{
                setResult(DemoGreenDAOActivity.RESULT_NEW_NOTE,returnIntent);
            }
            finish();
        });
    ...
    private void initData() {
        ...
        if(intent!= null){
            String title = intent.getStringExtra(DemoGreenDAOActivity.INIT_TITLE);
            String content = intent.getStringExtra(DemoGreenDAOActivity.INIT_CONTENT);
